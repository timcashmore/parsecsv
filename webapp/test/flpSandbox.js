					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Read Capabilities csv file and generate mapping",
									"targetURL": "#parsecsv-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"parsecsv-display": {
								"semanticObject": "parsecsv",
								"action": "display",
								"description": "Read Capabilities csv file and generate mapping",
								"title": "Read Capabilities csv file and generate mapping",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=parsecsv",
									"url": sap.ui.require.toUrl("parsecsv")
								}
							}
						}
					}
